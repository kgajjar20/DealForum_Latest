...
namespace DealForumAPI.Controllers
{
    ...
    public class AuthenticationApiController : ControllerBase
    {
        ...
        public AuthenticationApiController(IAdminLogin loginRepository, IConfiguration configuration, IException exception, IActionTracking tracking)
        {
                    ...
                    if (user != null)
                    {
                        ...
                        if (validate)
                        {
                            var claims = new[]
                            {
                                ...
                                new Claim("PortalType",PortalType.Admin.ToString()),
